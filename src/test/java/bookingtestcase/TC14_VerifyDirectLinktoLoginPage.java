...
public class TC14_VerifyDirectLinktoLoginPage extends BaseTestPage {
    @Test(description = "Test 14 - Verify click 'Đồng ý' navigate to Login Page")
    public void testCase14() throws InterruptedException {
        ...
        ExtentReportManager.info("Step 6: Click 'Đồng ý' button");
        LOG.info("Step 6: Click 'Đồng ý' button");
        bookingPage.ClickBtnYes();

        ExtentReportManager.info("VP2: Verify link is login page");
        LOG.info("VP1: Verify link is login page");
        String url = driver.getCurrentUrl();

        Assert.assertEquals(url, "https://demo1.cybersoft.edu.vn/sign-in", "FAIL");
