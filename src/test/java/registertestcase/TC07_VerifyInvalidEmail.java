...
public class TC07_VerifyInvalidEmail extends BaseTestPage {
    @Test(description = "RegisterPage Test 7 - Verify exist email contain special characters cannot register")
    public void testValidateEmailFieldWithSpecialCharacters() {
