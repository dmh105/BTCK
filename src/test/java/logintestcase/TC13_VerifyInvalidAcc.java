...
public class TC13_VerifyInvalidAcc extends BaseTestPage {
    @Test(description = "Login Test 13 - Xác minh không chấp nhận nhập tài khoản có khoảng trắng")
    public void testLogin13() {
        pages.LoginPage loginPage = new pages.LoginPage();
        driver.get("https://demo1.cybersoft.edu.vn/sign-in");

        ExtentReportManager.info("Step 1: nhập acc có khoảng trắng đầu dòng");
