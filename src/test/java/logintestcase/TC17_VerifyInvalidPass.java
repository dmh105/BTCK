...
public class TC17_VerifyInvalidPass extends BaseTestPage {
    @Test(description = "Login Test 16 - Xác minh không chấp nhận nhập password có khoảng trắng ở cuối dòng")
    public void testLogin16() {
        ...
        ExtentReportManager.info("Step 3: nhập password có khoảng trắng cuối dòng");
