...
public class TC18_SpecialCharactersInAcc extends BaseTestPage {
    @Test(description = "Login Test 18 - Xác minh không chấp nhận nhập ký tự đặc biệt trong trường tài khoản")
    public void testLogin18() {
        pages.LoginPage loginPage = new pages.LoginPage();
        driver.get("https://demo1.cybersoft.edu.vn/sign-in");
        ExtentReportManager.info("Step 1: nhập acc có ký tự đặc biệt");
